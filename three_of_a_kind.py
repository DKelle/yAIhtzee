...
class three_of_a_kind(lower_section_hand):
  ...
  def get_weight(self, dice):
    ...
    #
    #What is the chance we get a three of a kind if we re-roll these dice?
    #

    #3 - 'the number of good we already have' is the number of 'good' rolls we need to get a 3 of a kind
    good_still_needed = max(0, 3-common_roll)
    ...
    #What would our score be if we did get the three of a kind?
    total_score = (common_roll * 3) +  6 #6 because on average let's assume our other dice are 3
